...
public abstract class AbstractTinyOrderedLayoutConnector extends AbstractLayoutConnector {
	...
	private ElementResizeListener slotCaptionResizeListener = new ElementResizeListener() {
		...
		public void onElementResize(ElementResizeEvent e) {
			...
			CaptionPosition pos = getWidget().getCaptionPositionFromElement(captionElement.getParentElement());
