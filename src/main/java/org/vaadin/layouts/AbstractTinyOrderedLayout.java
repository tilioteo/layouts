...
public abstract class AbstractTinyOrderedLayout extends AbstractLayout
		implements Layout.AlignmentHandler, Layout.SpacingHandler, Layout.MarginHandler {
	...
	/**
	 * Constructs an empty AbstractTinyOrderedLayout.
	 */
	public AbstractTinyOrderedLayout() {
	}
